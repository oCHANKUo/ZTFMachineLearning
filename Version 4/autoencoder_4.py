...
with torch.no_grad():
    ...
    # Weighted by feature variance (rare features matter more)
...
for idx, row in anomalies.iterrows():
    ...
    # Top 3 features with highest reconstruction error
    ...
    print(f"   > Worst reconstructed: {', '.join([f'{f}({e:.3f})' for f, e in top3_features])}")
...
print(f"\nSaved {len(results)} anomalies to ae_anomalies.json")